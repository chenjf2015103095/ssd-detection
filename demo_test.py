...
# 导入新训练的模型参数
ckpt_filename = '/home/ubutnu/SSD-Tensorflow/train_dir/model.ckpt-10038'  # 注意xxx代表的数字是否和文件夹下的一致
...
# 测试的文件夹
path = '/home/ubutnu/SSD-Tensorflow/demo/'
image_names = sorted(os.listdir(path))
# 文件夹中的第几张图，-1代表最后一张
# img = mpimg.imread(path + image_names[-13])
